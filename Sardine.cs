...
{
    public class Sardine : MarineAnimal
    {
        public Sardine(string type, int rn, int cn, int fcl, int rcl) : base(rn, cn)
        {
            this.Type = type;
        ...
        public void Eat()
        {
            ...
            else
            {
                ...
                MarineAnimal ma = Program.GetElementByType("plankton",newRN, newCN);
